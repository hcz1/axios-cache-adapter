...
function setupCache() {
  ...
  config = Object(_config__WEBPACK_IMPORTED_MODULE_14__["makeConfig"])(config); // Axios adapter. Receives the axios request configuration as only parameter
...
function _read() {
  _read = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(config, req) {
    var uuid, ignoreCache, entry, error, expires, data, offline;
          ...
          case 3:
            ...
            if (config.readHeaders) {
              if (headers['cache-control']) {
                ...
                cacheControl = Object(cache_control_esm__WEBPACK_IMPORTED_MODULE_11__["parse"])(headers['cache-control']); // Force cache exlcusion for `cache-control: no-cache` and `cache-control: no-store`
